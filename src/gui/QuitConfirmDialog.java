...
public class QuitConfirmDialog extends JDialog {
    ...
    public QuitConfirmDialog(Mainframe frame) {
        ...
        JLabel text = new JLabel("<html>The game has not been saved.<br>Do you really want to quit?</html>");
        ...
        JButton yes = new RoundButton("Yes");
    ...
    private static class RoundedPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Clear the panel first (transparent corners)
            g2.setComposite(AlphaComposite.Clear);
            g2.fillRect(0, 0, getWidth(), getHeight());

            // Draw the rounded gradient rectangle

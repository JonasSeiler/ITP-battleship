...
public class Game_instructions extends JPanel { // JPanel ist ein Standard-Container oder Leinwand um Buttons usw. gut zu platzieren
    ...
    public Game_instructions(Mainframe frame) { // mainframe ist das Hauptfenster und game_instructions gibt Befehle an den mainframe
        ...
        gameInstructions.setText("General & Start\nHome screen: Access game settings and instructions via the hamburger menu.\nMode selection: Choose between singleplayer and multiplayer.\nLoad game: The player can select an existing saved game and continue playing from that point.\n\nSingleplayer mode\nStarting the game: Choose between 'Load Game' or starting a new game.\nConfiguration: When starting a new game, you can set the field size, number/type of ships, and bot difficulty level.\n\nMultiplayer mode\nJoin: Enter the IP address that appears when the host clicks the button 'IP Address' and then press 'Connect'.\nHosting: Open a game via 'Host Game'. Once a partner is connected, you can create a new game or load an old one.\n\nGameplay\nPlacement phase: Manually position ships with validation check (indicates whether the space is occupied or invalid).\nPlayers can also rotate the ship with r and remove it again by clicking on the placed ship.\nBattle phase: Alternate selection of target fields to fire at the enemy fleet.\nShip hit: Attacker may shoot again.\nShip destroyed: Fields surrounding the destroyed ship can no longer be fired upon.\nSaving: The current progress can be saved at any time during the game by clicking on 'Save Game'.\nVictory condition: The player who completely destroys all enemy ships first wins.\n\nShortcuts\nESC: 'Exit' (one screen)\nENTER: 'Start' (in the ship selection screen), 'Connect', 'Confirm Shot'.");
